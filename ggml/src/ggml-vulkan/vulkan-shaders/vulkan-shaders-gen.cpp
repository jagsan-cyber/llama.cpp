...
void process_shaders() {
    ...
    for (const bool& fp16 : {false, true}) {
        ...
        for (const bool& f16acc : {false, true}) {
            ...
            for (const auto& tname : type_names) {
                ...
                } else if (tname == "q4_0" || tname == "q8_0" || tname == "f32" || tname == "tq4_0") {
                    std::string data_a_key = "DATA_A_" + to_uppercase(tname);
                    string_to_spv("flash_attn_f32_f16_" + tname, "flash_attn_cm1.comp",
                ...
                // Generate all fp16 variants (including fp32/f16 as output types)
                if (tname == "f16") {
    ...
    for (std::string t : {"q4_0", "q4_1", "q5_0", "q5_1", "q8_0", "iq4_nl", "tq4_0"}) {
    ...
    for (std::string t : {"f32", "f16", "bf16", "q4_0", "q4_1", "q5_0", "q5_1", "q8_0", "iq4_nl", "tq4_0"}) {
