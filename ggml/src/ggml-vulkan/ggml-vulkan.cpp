...
#undef CREATE_MM
    ...
    ggml_vk_create_pipeline(device, device->pipeline_dequant[GGML_TYPE_TQ4_0],  "dequant_q4_0",   dequant_q4_0_len,   dequant_q4_0_data,   "main", 2, 5 * sizeof(uint32_t), {256 * 32, 1, 1}, {}, 1);
